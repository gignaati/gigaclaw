...
gigabot includes several security measures by default:
...
We do our best to follow security best practices, but **all software carries risk**. gigabot is provided as-is, without warranties of any kind. You are responsible for:

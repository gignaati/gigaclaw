...
import { gigabotDb, dataDir, PROJECT_ROOT } from '../paths.js';
...
export function getDb() {
  if (!_db) {
    ...
    const sqlite = new Database(gigabotDb);
...
export function initDatabase() {
  ...
  const migrationsFolder = path.join(PROJECT_ROOT, 'node_modules', 'gigabot', 'drizzle');

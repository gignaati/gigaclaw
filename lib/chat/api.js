...
export async function POST(request) {
  ...
  const { messages, chatId: rawChatId, trigger, codeMode, repo, branch, llmProvider, llmModel } = body;
  ...
  const stream = createUIMessageStream({
    ...
    execute: async ({ writer }) => {
      ...
      if (llmProvider) streamOptions.llmProvider = llmProvider;
      if (llmModel) streamOptions.llmModel = llmModel;

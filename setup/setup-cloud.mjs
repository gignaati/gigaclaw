...
export async function run() {
  clack.intro('Cloud Mode — Interactive Setup Wizard');
...
// Allow direct invocation: node setup/setup-cloud.mjs
if (process.argv[1] && process.argv[1].endsWith('setup-cloud.mjs')) {
  run().catch((error) => {
